...
{
	return BitCount == 32 || BitCount == 8 || BitCount == 4 || BitCount == 1; // 7-ой вариант
}
...
int main(void)
{
	...
	Image* im1 = new Image((char*)"sunset.bmp"); // Создание объекта изображения из файла 
	Image* im2 = new Image(0, 32, 1280-400, 960+400);// Создание изображения с заданными параметрами 
	...
	im3.writeimage((char*)"sunset_8.bmp");
	im4.writeimage((char*)"sunset_4.bmp");
	im2->writeimage((char*)"sunset_res.bmp");

	printf("sunset.bmp have been converted.\n");
	scanf(" ");
	return 0;
}