...
int main(void)
{
	...
	Image* im1 = new Image((char*)"apple.bmp"); // Создание объекта изображения из файла 
	Image* im2 = new Image(0, 32, 540, 718);// Создание изображения с заданными параметрами 
	...
	im3.writeimage((char*)"apple_8.bmp");
	im4.writeimage((char*)"apple_4.bmp");
	im2->writeimage((char*)"apple_res.bmp");
